      ...
      <div className="flex flex-col md:flex-row justify-evenly p-4 md:p-14 font-bold text-black min-h-screen">
        ...
        <div className="items-center basis-full md:basis-1/2 p-4 md:p-[2rem] space-y-4 md:space-y-8 w-full">
            ...
            <div className="w-full h-full items-center py-8 md:py-24">
              ...
              <p className="text-2xl md:text-4xl font-semibold text-indigo-800">$120.00</p>

              <h1 className="text-4xl md:text-8xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-900 to-indigo-600">Man summer collection</h1>

              <p className="text-lg md:text-2xl mt-4 text-gray-700 leading-relaxed">
              ...
              <button className="mt-6 px-8 py-3 bg-indigo-800 text-white rounded-full hover:bg-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg">SHOP NOW</button>
