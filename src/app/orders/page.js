                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="font-medium">{typeof order.reference === 'string' ? order.reference : order.reference.reference}</p>
                      </div>
                    ...
                    <div className="border-t border-gray-200 mt-4 pt-4">
                      ...
                      <p className="text-sm text-gray-500 mt-1">Paid with Paystack</p>
                    </div>
                  </div>
                </div>
              ))}
